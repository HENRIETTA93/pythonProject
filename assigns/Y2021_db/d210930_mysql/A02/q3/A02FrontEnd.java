...
public class A02FrontEnd extends JFrame implements ItemListener, ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        String showQueryOutput = "";
        if (allDates.isSelected() && (eventBook.isSelected() && eventConference.isSelected() && eventJournal.isSelected()
                ||
                !eventBook.isSelected() && !eventConference.isSelected() && !eventJournal.isSelected()
        )) {
            ArrayList<String> eventsList = new A02MiddleTier().displayQueryEvents();
//    		showQueryOutput+="ID,  Name              , EventWebLink                             , CFPText     \n";
            for (String event : eventsList) {
                showQueryOutput += event + "\n";
            }
            queryOutput.setText(showQueryOutput);
            showQueryOutput = "";
            ...
            ArrayList<String> eventsList = new A02MiddleTier().displayQueryEvents(from, to);
            for (String event : eventsList) {
                showQueryOutput += event + "\n";
            }
            queryOutput.setText(showQueryOutput + "\n" + fromDate.getText() + "\n" + toDate.getText());
            showQueryOutput = "";
        } else if (allDates.isSelected() && eventBook.isSelected()
                && !eventJournal.isSelected()
                && !eventConference.isSelected()
        ) {
            ArrayList<String> eventsList = new A02MiddleTier().displayQueryBook(null, null);
            for (String event : eventsList) {
                showQueryOutput += event + "\n";
            }
            queryOutput.setText(showQueryOutput);
            showQueryOutput = "";
        } else if (dateRange.isSelected() && eventBook.isSelected()
                && !eventJournal.isSelected()
                && !eventConference.isSelected()
        ) {
            String from = fromDate.getText();
            String to = toDate.getText();
            ArrayList<String> eventsList = new A02MiddleTier().displayQueryBook(from, to);
            for (String event : eventsList) {
                showQueryOutput += event + "\n";
            }
            queryOutput.setText(showQueryOutput);
            showQueryOutput = "";
        } else if (allDates.isSelected() && eventConference.isSelected()
                && !eventJournal.isSelected()
                && !eventBook.isSelected()
        ) {
            ArrayList<String> eventsList = new A02MiddleTier().displayQueryConferences(null, null);
            for (String event : eventsList) {
                showQueryOutput += event + "\n";
            }
            queryOutput.setText(showQueryOutput);
            showQueryOutput = "";
        } else if (dateRange.isSelected() && eventConference.isSelected()
                && !eventJournal.isSelected()
                && !eventBook.isSelected()
        ) {
            String from = fromDate.getText();
            String to = toDate.getText();
            ArrayList<String> eventsList = new A02MiddleTier().displayQueryConferences(from, to);
            for (String event : eventsList) {
                showQueryOutput += event + "\n";
            }
            queryOutput.setText(showQueryOutput);
            showQueryOutput = "";
        } else if (allDates.isSelected() && eventJournal.isSelected()
                && !eventConference.isSelected()
                && !eventBook.isSelected()
        ) {
            ArrayList<String> eventsList = new A02MiddleTier().displayQueryJournal(null, null);
            for (String event : eventsList) {
                showQueryOutput += event + "\n";
            }
            queryOutput.setText(showQueryOutput);
            showQueryOutput = "";
        } else if (dateRange.isSelected() && eventJournal.isSelected()
                && !eventConference.isSelected()
                && !eventBook.isSelected()
        ) {
            String from = fromDate.getText();
            String to = toDate.getText();
            ArrayList<String> eventsList = new A02MiddleTier().displayQueryJournal(from, to);
            for (String event : eventsList) {
                showQueryOutput += event + "\n";
            }
            queryOutput.setText(showQueryOutput);
            ...
            ArrayList<String> eventsList1 = new A02MiddleTier().displayQueryJournal(null, null);
            ArrayList<String> eventsList2 = new A02MiddleTier().displayQueryConferences(null, null);
            for (String event : eventsList1) {
                showQueryOutput += event + "\n";
            }
            for (String event : eventsList2) {
                showQueryOutput += event + "\n";
            }
            queryOutput.setText(showQueryOutput);
            showQueryOutput = "";
            ...
            String from = fromDate.getText();
            String to = toDate.getText();
            ArrayList<String> eventsList1 = new A02MiddleTier().displayQueryJournal(from, to);
            ArrayList<String> eventsList2 = new A02MiddleTier().displayQueryConferences(from, to);
            for (String event : eventsList1) {
                showQueryOutput += event + "\n";
            }
            for (String event : eventsList2) {
            ...
            ArrayList<String> eventsList1 = new A02MiddleTier().displayQueryJournal(null, null);
            ArrayList<String> eventsList2 = new A02MiddleTier().displayQueryBook(null, null);
            for (String event : eventsList1) {
                showQueryOutput += event + "\n";
            }
            for (String event : eventsList2) {
            ...
            String to = toDate.getText();
            ArrayList<String> eventsList1 = new A02MiddleTier().displayQueryJournal(from, to);
            ArrayList<String> eventsList2 = new A02MiddleTier().displayQueryBook(from, to);
            for (String event : eventsList1) {
                showQueryOutput += event + "\n";
            }
            for (String event : eventsList2) {
            ...
            ArrayList<String> eventsList1 = new A02MiddleTier().displayQueryConferences(null, null);
            ArrayList<String> eventsList2 = new A02MiddleTier().displayQueryBook(null, null);
            for (String event : eventsList1) {
                showQueryOutput += event + "\n";
            }
            ...
            String from = fromDate.getText();
            String to = toDate.getText();
            ArrayList<String> eventsList1 = new A02MiddleTier().displayQueryConferences(from, to);
            ArrayList<String> eventsList2 = new A02MiddleTier().displayQueryBook(from, to);
            for (String event : eventsList1) {
                showQueryOutput += event + "\n";
            }
