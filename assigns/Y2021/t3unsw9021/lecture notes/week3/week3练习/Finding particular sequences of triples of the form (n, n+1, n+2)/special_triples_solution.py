...
for n in range(100, 1_000):
    ...
    # hence n is incremented by only 1 in the next iteration
    # of the loop.
    # We could avoid checking that sums_of_two_squares[n + 1] and
    # sums_of_two_squares[n + 2] are not equal to 0, but why make
    # the program more complicated for no significant gain?
