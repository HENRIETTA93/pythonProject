...
if movies is not None and len(movies) > 0:
    ...
    # for mid1 in movieids:
    #     aid1s=find_actors(actor1[0], mid1)
    #     for aid1 in aid1s:
    #         if aid1== actor2[0]:
    #             print(actor1, mid1, actor2)
    #             m=find_movie(mid1)
    #             result=actor1[1]+ was_in + m[0]+ " (" + str(m[1]) + ") " + withs + actor2[1]
    #             results.append(result)
    #         else:
    #             tmp_result=""
    #             movieids2=find_movies(aid1)
    #             for mid2 in movieids2:
    #                 aids2=find_actors(aid1, mid2)
    #                 for aid2 in aids2:
    #                     if aid2==actor2[0]:
    #                         print(actor1,mid1,aid1, mid2, aid2,actor2)
    #                         m=find_movie(mid2)
    #                         a=find_actor(aid2)
    #                         tmp_result+=actor1[1]+ was_in + m[0]+ " (" + str(m[1]) + ") " + withs + a[1]+";"
    #                     else:
    #                         movieids3 = find_movies(aid2)
    #                         for mid3 in movieids3:
    #                             aids3=find_actors(aid2,mid3)
    #                             for aid3 in aids3:
    #                                 if aid3==actor2[0]:
    #                                     # print(actor1, mid1, aid1,mid2, aid2, mid3, aid3,actor2)
    #                                     m = find_movie(mid3)
    #                                     a = find_actor(aid3)
    #                                     _a=find_actor(aid2)
    #                                     tmp_result += _a[1] + was_in + m[0] + " (" + str(m[1]) + ") " + withs + a[
    #                                         1] + ";"
    #                                     continue
    #                                 else:
    #
    #                                     movieids4 = find_movies(aid3)
    #                                     for mid4 in movieids4:
    #                                         aids4 = find_actors(aid3, mid4)
    #                                         for aid4 in aids4:
    #                                             if aid4 == actor2[0]:
    #                                                 print(actor1, mid1, aid1, mid2, aid2, mid3, aid3, mid4, aid4,actor2)
    #                                                 continue
    #                                             else:
    #
    #                                                 movieids5 = find_movies(aid4)
    #                                                 for mid5 in movieids5:
    #                                                     aids5 = find_actors(aid4, mid5)
    #                                                     for aid5 in aids5:
    #                                                         if aid5 == actor2[0]:
    #                                                             print(actor1, mid1, aid1, mid2, aid2, mid3, aid3, mid4,
    #                                                                   aid4,mid5, aid5, actor2)
    #                                                             continue
    #                                                         else:
    #                                                             movieids6 = find_movies(aid5)
    #                                                             for mid6 in movieids6:
    #                                                                 aids6 = find_actors(aid5, mid6)
    #                                                                 for aid6 in aids6:
    #                                                                     if aid6 == actor2[0]:
    #                                                                         print(actor1, mid1, aid1, mid2, aid2, mid3,
    #                                                                               aid3, mid4,
    #                                                                               aid4, mid5, aid5,mid6,aid6, actor2)
    #                                                                     else:
    #                                                                         pass
    ...
    for movieid in movieids:
        find_actor = "select actor_id from acting where movie_id=" + str(movieid)
        cur.execute(find_actor)
        actors = cur.fetchall()
