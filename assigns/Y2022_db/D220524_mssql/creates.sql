...
-- select distinct [Supplier Name], website
-- from [Chocolate Bars]
-- union
-- select distinct [Supplier Name], website
...
-- select distinct [Product ID], [Product Descriptions], Discontinued, [Supplier Name], [Unit Price], 'Chocolate Bars' as Category_Name
-- from [Chocolate Bars]
-- where [Product ID] is not null
-- union
-- select distinct [Product ID], [Product Descriptions], Discontinued, [Supplier Name], [Unit Price], 'Chocolate Boxed' as Category_Name
-- from [Chocolate Boxed]
-- where [Product ID] is not null
-- union
-- select distinct [Product ID], [Product Descriptions], Discontinued, [Supplier Name], [Unit Price], 'Condiments' as Category_Name
-- from Condiments
-- where [Product ID] is not null
-- union
-- select distinct [Product ID], [Product Descriptions], Discontinued, [Supplier Name], [Unit Price], 'Confectionery' as Category_Name
-- from Confectionery
-- where [Product ID] is not null
-- union
-- select distinct [Product ID], [Product Description], Discontinued, [Supplier Name], [Unit Price], 'No Sugar Added' as Category_Name
-- from [No Sugar Added]
-- where [Product ID] is not null
-- union
-- select distinct [Product ID], [Product Descriptions], Discontinued, [Supplier Name], [Unit Price], 'Pick and Mix' as Category_Name
-- from [Pick and Mix]
-- where [Product ID] is not null
