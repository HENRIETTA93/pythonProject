...
('Chocolate Bars','Retail Product'),
('Chocolate Boxed','Retail Product'),
('Condiments','Retail Product'),
('Confectionery','Retail Product'),
('Gourmet Foods','Retail Product'),
('No Sugar Added','Retail Product'),
('Pick and Mix','Retail Product');
