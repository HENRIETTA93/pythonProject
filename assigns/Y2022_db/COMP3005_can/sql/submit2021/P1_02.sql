...
select lines.areacode,lines.officecode,count(subscribers.name) as subscribers_num
from lines join facilities on lines.portid=facilities.portid
...
areacode    officecode  subscribers_num
----------  ----------  ---------------
416         219         2
416         331         2
416         333         2
